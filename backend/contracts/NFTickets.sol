...
contract NFTickets is ERC721URIStorage, VRFConsumerBase, Ownable {
    ...
    constructor() ERC721("NFTicket", "NFT") VRFConsumerBase(
        ...
        return string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',eventName,' NFTicket", ',
                                '"description":"A ticket secured on the polygon blockchain, generated by the NFTickets team.", ',
                                '"attributes":['
